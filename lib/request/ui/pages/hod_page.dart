...
class HodPage extends StatefulWidget {
  final List<Hod> hoddatalist;
  const HodPage({
    super.key,
    required this.hoddatalist,
  });
...
class _HodPageState extends State<HodPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: widget.hoddatalist.isEmpty
            ...
            : SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    ListView.builder(
                        itemCount: widget.hoddatalist.length,
                        shrinkWrap: true,
                        itemBuilder: (context, index) {
                          return Container(
                            ...
                            child: GestureDetector(
                              ...
                              child: ListTile(
                                title: Text(
                                  "Class: ${widget.hoddatalist[index].classRoom!.classRoomname}",
